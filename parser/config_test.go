...
func (d FakeHephyCmd) ConfigList(string, string) error {
	return errors.New("config:list")
}

func (d FakeHephyCmd) ConfigSet(string, []string) error {
	return errors.New("config:set")
}

func (d FakeHephyCmd) ConfigUnset(string, []string) error {
	return errors.New("config:unset")
}

func (d FakeHephyCmd) ConfigPull(string, bool, bool) error {
	return errors.New("config:pull")
}

func (d FakeHephyCmd) ConfigPush(string, string) error {
