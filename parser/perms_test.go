...
func (d FakeHephyCmd) PermsList(string, bool, int) error {
	return errors.New("perms:list")
}

func (d FakeHephyCmd) PermCreate(string, string, bool) error {
	return errors.New("perms:create")
}

func (d FakeHephyCmd) PermDelete(string, string, bool) error {
