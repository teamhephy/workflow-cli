...
func (d FakeHephyCmd) Register(string, string, string, string, bool, bool) error {
	return errors.New("auth:register")
}

func (d FakeHephyCmd) Login(string, string, string, bool) error {
	return errors.New("auth:login")
}

func (d FakeHephyCmd) Logout() error {
	return errors.New("auth:logout")
}

func (d FakeHephyCmd) Passwd(string, string, string) error {
	return errors.New("auth:passwd")
}

func (d FakeHephyCmd) Cancel(string, string, bool) error {
	return errors.New("auth:cancel")
}

func (d FakeHephyCmd) Whoami(bool) error {
	return errors.New("auth:whoami")
}

func (d FakeHephyCmd) Regenerate(string, bool) error {
