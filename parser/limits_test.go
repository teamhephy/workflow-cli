...
func (d FakeHephyCmd) LimitsList(string) error {
	return errors.New("limits:list")
}

func (d FakeHephyCmd) LimitsSet(string, []string, string) error {
	return errors.New("limits:set")
}

func (d FakeHephyCmd) LimitsUnset(string, []string, string) error {
