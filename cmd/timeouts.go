...
func (d *HephyCmd) TimeoutsList(appID string) error {
...
func (d *HephyCmd) TimeoutsSet(appID string, timeouts []string) error {
	s, appID, err := load(d.ConfigFile, appID)
...
func (d *HephyCmd) TimeoutsUnset(appID string, timeouts []string) error {
	s, appID, err := load(d.ConfigFile, appID)
